...
## IMPORTANT !!! : COPY THE FOLDER _debian-install_ INTO $Home/Templates OR CHANGE PATH INSIDE THE SCRIPT WHERE IT ASKS FOR THIS PATH OR *install-arcolinux-chadwm.sh* WILL NOT COPY THE IMPORTANT FILES TO PROPRIATE DIRECTORIES !!!
